...
<body class="h-full">
    <div x-data="{ sidebarOpen: false }">
        ...
        <div class="relative z-50 lg:hidden" role="dialog" aria-modal="true" x-cloak x-show="sidebarOpen" x-transition>
                ...
                <div class="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                        <div class="flex h-16 shrink-0 items-center">
                            ...
                            <span
                                class="ml-4 text-sm font-semibold leading-6 text-gray-900">{{ config('app.name') }}</span>
                        </div>
                                    ...
                                    <ul role="list" class="-mx-2 space-y-1">
                                        <li>
                                            ...
                                            <a wire:navigate href="{{ route('home') }}" @class([
                                                ...
                                                'bg-gray-50 text-indigo-600' => request()->routeIs('home'),
                                            ])>
                                                <svg @class([
                                                    'h-6 w-6 shrink-0 text-gray-400 group-hover:text-indigo-600',
                                                    'text-indigo-600' => request()->routeIs('home'),
                                                ]) fill="none"
                                        ...
                                        <li>
                                            <a wire:navigate href="{{ route('customers.index') }}" @class([
                                                'text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold',
                                                'bg-gray-50 text-indigo-600' => request()->routeIs('customers.*'),
                                            ])>
                                                <svg @class([
                                                    'h-6 w-6 shrink-0 text-gray-400 group-hover:text-indigo-600',
                                                    'text-indigo-600' => request()->routeIs('customers.*'),
        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
                <div class="flex h-16 shrink-0 items-center">
                    ...
                    <span class="ml-4 text-sm font-semibold leading-6 text-gray-900">{{ config('app.name') }}</span>
                </div>
                <nav class="flex flex-1 flex-col">
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        <li>
                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button"
                                aria-expanded="false" aria-haspopup="true" x-on:click="open = !open">
                            ...
                            <div class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none"
                                ...
                                tabindex="-1" x-cloak x-show="open" x-transition>
                                ...
                                <a href="#" class="block px-3 py-1 text-sm leading-6 text-gray-900"
                                    role="menuitem" tabindex="-1" id="user-menu-item-1">{{ __('Sign out') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
